...
export class LoginComponent implements OnInit {
  ...
  constructor(private http:HttpClient,private services:AuthService,private router:Router , private toastr:ToastrService){
...
submit() {
  ...
  if(index == -1) {
    ...
    // this.services.login(model).subscribe(res => {
